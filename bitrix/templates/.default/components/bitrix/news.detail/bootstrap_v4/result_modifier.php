...
// Получение информации о соседних элементах для кастомной навигации
// Все записывается в $arResult['CUSTOM_NAVIGATION']
...
while ($arElement = $rsElement -> GetNext()) {
   $arNavElements[$iIndex] = $arElement;
...
$arCustomNavigation['PREVIOUS'] = isset($arNavElements[$iElementIndex - 1]) ? $arNavElements[$iElementIndex - 1] : null;
$arCustomNavigation['NEXT'] = isset($arNavElements[$iElementIndex + 1]) ? $arNavElements[$iElementIndex + 1] : null;

if (!empty($arCustomNavigation['PREVIOUS']) || !empty($arCustomNavigation['NEXT']))
	$arCustomNavigation['SHOW'] = true;

$arResult['CUSTOM_NAVIGATION'] = $arCustomNavigation;

unset($arCustomNavigation, $arElement, $arNavElements, $rsElement, $arFields, $arFilter, $iElementIndex, $iIndex);